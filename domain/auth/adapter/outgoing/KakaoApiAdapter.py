from domain.auth.application.port.outgoing.KakaoDao import KakaoDao
from domain.auth.domain.KakaoUserInfo import KakaoUserInfo
import requests
...
class ApiKakaoAdapter(KakaoDao):
    ...
    #     }
    #     res = requests.group(url, headers=header, data=data)
    #
    #     json = res.json()
